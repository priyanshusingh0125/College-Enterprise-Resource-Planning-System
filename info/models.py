...
class Student(models.Model):
    ...
    DOB = models.DateField(default='2023-07-01')
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Periodic test 1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Periodic test 1')
                    sc.marks_set.create(name='Periodic test 2')
                    sc.marks_set.create(name='Periodic test 3')
